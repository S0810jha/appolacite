            ...
            <div className="flex flex-col gap-4 m-5">
                ...
                <div className="flex-1 border-stone-100 rounded-lg p-8 py-7 bg-white">
                    ...
                    <p className="text-gray-600 font-medium mt-4">
                      Appointment Fee: <span className="text-gray-600">{currency} {isEdit ? <input type="text" onChange={(e)=>setProfileData(prev => ({...prev, fee: e.target.value}))}  value={profileData.fee} />  : profileData.fee}</span>
                    </p>
                    ...
                    {
                      isEdit
                      ?<button onClick={updateProfile} className="px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-primary hover:text-white transition-all duration-300">Save Info</button>
